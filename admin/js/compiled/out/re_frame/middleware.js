...
var G__22619 = db;
var G__22620 = cljs.core.vec(cljs.core.rest(v));
return (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(G__22619,G__22620) : handler.call(null,G__22619,G__22620));
});
});
/**
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__22622){
...
var G__22637 = (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(db,v) : handler.call(null,db,v));
var G__22638 = v;
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__22639_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,new_ins){
return (function (p1__22640_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,p1__22640_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__22641__i = 0, G__22641__a = new Array(arguments.length -  2);
while (G__22641__i < G__22641__a.length) {G__22641__a[G__22641__i] = arguments[G__22641__i + 2]; ++G__22641__i;}
  in_paths = new cljs.core.IndexedSeq(G__22641__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__22642){
var f = cljs.core.first(arglist__22642);
arglist__22642 = cljs.core.next(arglist__22642);
var out_path = cljs.core.first(arglist__22642);
var in_paths = cljs.core.rest(arglist__22642);
