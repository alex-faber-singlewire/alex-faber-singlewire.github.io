...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5192__auto__,writer__5193__auto__,opt__5194__auto__){
return cljs.core._write(writer__5193__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4594__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4594__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4594__auto__)){
return or__4594__auto__;
} else {
...
var G__22266 = o;
(G__22266[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_22270 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_22270))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_22270)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__4582__auto__ = (node === document.activeElement);
if(and__4582__auto__){
var and__4582__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
...
if(cljs.core.truth_((function (){var and__4582__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__22273 = jsprops;
(G__22273["defaultValue"] = value);

(G__22273["onChange"] = ((function (G__22273,v,value,on_change){
return (function (p1__22271_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22271_SHARP_);
});})(G__22273,v,value,on_change))
);
...
var vec__22275 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(2),null);
...
var temp__4427__auto__ = (function (){var G__22279 = cljs.core.meta(v);
var G__22279__$1 = (((G__22279 == null))?null:reagent.impl.template.get_key(G__22279));
return G__22279__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__22281_22282 = v;
var G__22281_22283__$1 = (((G__22281_22282 == null))?null:reagent.impl.template.key_from_vec(G__22281_22282));
var G__22281_22284__$2 = (((G__22281_22283__$1 == null))?null:(jsprops["key"] = G__22281_22283__$1));
...
var G__22288 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22288) : reagent.impl.template.as_element.call(null,G__22288));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__22289 = cljs.core.meta(argv);
var G__22289__$1 = (((G__22289 == null))?null:reagent.impl.template.get_key(G__22289));
return G__22289__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__22290 = (((jsprops == null))?{}:jsprops);
(G__22290["key"] = key);
...
var G__22291 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__22291;
continue;
}
} else {
...
var n__5497__auto___22292 = a.length;
var i_22293 = (0);
while(true){
if((i_22293 < n__5497__auto___22292)){
(a[i_22293] = reagent.impl.template.as_element((a[i_22293])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5497__auto___22295 = a.length;
var i_22296 = (0);
while(true){
if((i_22296 < n__5497__auto___22295)){
var val_22297 = (a[i_22296]);
if((cljs.core.vector_QMARK_(val_22297)) && ((reagent.impl.template.key_from_vec(val_22297) == null))){
(o["no-key"] = true);
} else {
}

(a[i_22296] = reagent.impl.template.as_element(val_22297));

var G__22298 = (i_22296 + (1));
i_22296 = G__22298;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__4582__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4582__auto__){
return (ctx["no-key"]);
} else {
return and__4582__auto__;
...
var G__22300 = (cljs.core.count(argv) - first_child);
switch (G__22300) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__22300){
