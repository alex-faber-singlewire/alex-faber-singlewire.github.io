...
var G__17718 = o;
(G__17718[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
return (function() { 
var G__17719__delegate = function (args){
...
return G__17719__delegate.call(this,args);};
...
return G__17719__delegate(args);
});
...
var old_17722 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_17722))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_17722)].join(''):class$));
} else {
}
...
var G__17725 = jsprops;
(G__17725["defaultValue"] = value);

(G__17725["onChange"] = ((function (G__17725,v,value,on_change){
return (function (p1__17723_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17723_SHARP_);
});})(G__17725,v,value,on_change))
);
...
var vec__17727 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17727,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17727,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17727,(2),null);
...
var temp__4427__auto__ = (function (){var G__17731 = cljs.core.meta(v);
var G__17731__$1 = (((G__17731 == null))?null:reagent.impl.template.get_key(G__17731));
return G__17731__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__17733_17734 = v;
var G__17733_17735__$1 = (((G__17733_17734 == null))?null:reagent.impl.template.key_from_vec(G__17733_17734));
var G__17733_17736__$2 = (((G__17733_17735__$1 == null))?null:(jsprops["key"] = G__17733_17735__$1));
...
var G__17740 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17740) : reagent.impl.template.as_element.call(null,G__17740));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__17741 = cljs.core.meta(argv);
var G__17741__$1 = (((G__17741 == null))?null:reagent.impl.template.get_key(G__17741));
return G__17741__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__17742 = (((jsprops == null))?{}:jsprops);
(G__17742["key"] = key);
...
var G__17743 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__17743;
continue;
}
} else {
...
var n__5571__auto___17744 = a.length;
var i_17745 = (0);
while(true){
if((i_17745 < n__5571__auto___17744)){
(a[i_17745] = reagent.impl.template.as_element((a[i_17745])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5571__auto___17747 = a.length;
var i_17748 = (0);
while(true){
if((i_17748 < n__5571__auto___17747)){
var val_17749 = (a[i_17748]);
if((cljs.core.vector_QMARK_(val_17749)) && ((reagent.impl.template.key_from_vec(val_17749) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17748] = reagent.impl.template.as_element(val_17749));

var G__17750 = (i_17748 + (1));
i_17748 = G__17750;
continue;
} else {
}
...
var G__17752 = (cljs.core.count(argv) - first_child);
switch (G__17752) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__17752){
