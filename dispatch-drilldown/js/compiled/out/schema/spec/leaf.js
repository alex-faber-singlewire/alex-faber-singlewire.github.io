...
schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5284__auto__,k15501,else__5285__auto__){
var self__ = this;
var this__5284__auto____$1 = this;
var G__15503 = (((k15501 instanceof cljs.core.Keyword))?k15501.fqn:null);
switch (G__15503) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k15501,else__5285__auto__);
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__15500){
var self__ = this;
var G__15500__$1 = this;
return (new cljs.core.RecordIter((0),G__15500__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre], null),cljs.core._iterator(self__.__extmap)));
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5289__auto__,k__5290__auto__,G__15500){
var self__ = this;
var this__5289__auto____$1 = this;
var pred__15504 = cljs.core.keyword_identical_QMARK_;
var expr__15505 = k__5290__auto__;
if(cljs.core.truth_((pred__15504.cljs$core$IFn$_invoke$arity$2 ? pred__15504.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pre,expr__15505) : pred__15504.call(null,cljs.core.cst$kw$pre,expr__15505)))){
return (new schema.spec.leaf.LeafSpec(G__15500,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5290__auto__,G__15500),null));
}
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5281__auto__,G__15500){
var self__ = this;
var this__5281__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__15500,self__.__extmap,self__.__hash));
});
...
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__15502){
return (new schema.spec.leaf.LeafSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__15502),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__15502,cljs.core.cst$kw$pre),null));
});
