...
var G__17996 = db;
var G__17997 = cljs.core.vec(cljs.core.rest(v));
return (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(G__17996,G__17997) : handler.call(null,G__17996,G__17997));
});
});
/**
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__17999){
...
var G__18014 = (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(db,v) : handler.call(null,db,v));
var G__18015 = v;
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__18016_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,new_ins){
return (function (p1__18017_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,p1__18017_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__18018__i = 0, G__18018__a = new Array(arguments.length -  2);
while (G__18018__i < G__18018__a.length) {G__18018__a[G__18018__i] = arguments[G__18018__i + 2]; ++G__18018__i;}
  in_paths = new cljs.core.IndexedSeq(G__18018__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__18019){
var f = cljs.core.first(arglist__18019);
arglist__18019 = cljs.core.next(arglist__18019);
var out_path = cljs.core.first(arglist__18019);
var in_paths = cljs.core.rest(arglist__18019);
