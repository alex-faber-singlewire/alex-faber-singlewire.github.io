...
return cljs.core._write(writer__5106__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4526__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4526__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4526__auto__)){
return or__4526__auto__;
} else {
...
var G__11603 = o;
(G__11603[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
while (G__11605__i < G__11605__a.length) {G__11605__a[G__11605__i] = arguments[G__11605__i + 0]; ++G__11605__i;}
  args = new cljs.core.IndexedSeq(G__11605__a,0);
} 
...
var old_11607 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_11607))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_11607)].join(''):class$));
} else {
}
...
var G__11610 = jsprops;
(G__11610["defaultValue"] = value);

(G__11610["onChange"] = ((function (G__11610,v,value,on_change){
return (function (p1__11608_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__11608_SHARP_);
});})(G__11610,v,value,on_change))
);
...
var vec__11612 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11612,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11612,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11612,(2),null);
...
var temp__4427__auto__ = (function (){var G__11614 = cljs.core.meta(v);
var G__11614__$1 = (((G__11614 == null))?null:reagent.impl.template.get_key(G__11614));
return G__11614__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__11616_11617 = v;
var G__11616_11618__$1 = (((G__11616_11617 == null))?null:reagent.impl.template.key_from_vec(G__11616_11617));
var G__11616_11619__$2 = (((G__11616_11618__$1 == null))?null:(jsprops["key"] = G__11616_11618__$1));
...
var G__11623 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__11623) : reagent.impl.template.as_element.call(null,G__11623));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__11624 = cljs.core.meta(argv);
var G__11624__$1 = (((G__11624 == null))?null:reagent.impl.template.get_key(G__11624));
return G__11624__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__11625 = (((jsprops == null))?{}:jsprops);
(G__11625["key"] = key);
...
var n__5410__auto___11626 = a.length;
var i_11627 = (0);
while(true){
if((i_11627 < n__5410__auto___11626)){
(a[i_11627] = reagent.impl.template.as_element((a[i_11627])));

var G__11628 = (i_11627 + (1));
i_11627 = G__11628;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5410__auto___11629 = a.length;
var i_11630 = (0);
while(true){
if((i_11630 < n__5410__auto___11629)){
var val_11631 = (a[i_11630]);
if((cljs.core.vector_QMARK_(val_11631)) && ((reagent.impl.template.key_from_vec(val_11631) == null))){
(o["no-key"] = true);
} else {
}

(a[i_11630] = reagent.impl.template.as_element(val_11631));

var G__11632 = (i_11630 + (1));
i_11630 = G__11632;
continue;
} else {
}
...
var G__11634 = (cljs.core.count(argv) - first_child);
switch (G__11634) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__11634){
