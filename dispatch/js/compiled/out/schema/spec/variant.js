...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5284__auto__,k15481,else__5285__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k15481,else__5285__auto__);
...
return (function (){
var G__15484 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__15484) : self__.err_f.call(null,G__15484));
});})(this$__$1))
,null)),null));
});})(this$__$1))
...
var or__4668__auto____$1 = (function (){var G__15486 = (cljs.core.truth_(cljs.core.cst$kw$return_DASH_walked_QMARK_.cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__15486) : self__.post.call(null,G__15486));
})();
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__15480){
var self__ = this;
var G__15480__$1 = this;
return (new cljs.core.RecordIter((0),G__15480__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], null),cljs.core._iterator(self__.__extmap)));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5289__auto__,k__5290__auto__,G__15480){
var self__ = this;
var this__5289__auto____$1 = this;
var pred__15487 = cljs.core.keyword_identical_QMARK_;
var expr__15488 = k__5290__auto__;
if(cljs.core.truth_((pred__15487.cljs$core$IFn$_invoke$arity$2 ? pred__15487.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pre,expr__15488) : pred__15487.call(null,cljs.core.cst$kw$pre,expr__15488)))){
return (new schema.spec.variant.VariantSpec(G__15480,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__15487.cljs$core$IFn$_invoke$arity$2 ? pred__15487.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$options,expr__15488) : pred__15487.call(null,cljs.core.cst$kw$options,expr__15488)))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__15480,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__15487.cljs$core$IFn$_invoke$arity$2 ? pred__15487.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$err_DASH_f,expr__15488) : pred__15487.call(null,cljs.core.cst$kw$err_DASH_f,expr__15488)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__15480,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__15487.cljs$core$IFn$_invoke$arity$2 ? pred__15487.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$post,expr__15488) : pred__15487.call(null,cljs.core.cst$kw$post,expr__15488)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__15480,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5290__auto__,G__15480),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5281__auto__,G__15480){
var self__ = this;
var this__5281__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__15480,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__15482){
return (new schema.spec.variant.VariantSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__15482),cljs.core.cst$kw$options.cljs$core$IFn$_invoke$arity$1(G__15482),cljs.core.cst$kw$err_DASH_f.cljs$core$IFn$_invoke$arity$1(G__15482),cljs.core.cst$kw$post.cljs$core$IFn$_invoke$arity$1(G__15482),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__15482,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$options,cljs.core.cst$kw$err_DASH_f,cljs.core.cst$kw$post], 0)),null));
});
...
args15491.push((arguments[i__5727__auto___15495]));
